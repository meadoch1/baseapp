...
RSpec.describe CarPointsController, :type => :controller do
  ...
  # CarPoint. As you add validations to CarPoint, be sure to
  ...
  # CarPointsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested car_point as @car_point" do
      car_point = CarPoint.create! valid_attributes
      get :show, {:id => car_point.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested car_point as @car_point" do
      car_point = CarPoint.create! valid_attributes
      get :edit, {:id => car_point.to_param}, valid_session
      expect(assigns(:car_point)).to eq(car_point)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new CarPoint" do
        expect {
          post :create, {:car_point => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved car_point as @car_point" do
        post :create, {:car_point => invalid_attributes}, valid_session
        expect(assigns(:car_point)).to be_a_new(CarPoint)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested car_point" do
        car_point = CarPoint.create! valid_attributes
        put :update, {:id => car_point.to_param, :car_point => new_attributes}, valid_session
        car_point.reload
      ...
      it "assigns the requested car_point as @car_point" do
        car_point = CarPoint.create! valid_attributes
        put :update, {:id => car_point.to_param, :car_point => valid_attributes}, valid_session
        expect(assigns(:car_point)).to eq(car_point)
      end
    ...
    describe "with invalid params" do
      it "assigns the car_point as @car_point" do
        car_point = CarPoint.create! valid_attributes
        put :update, {:id => car_point.to_param, :car_point => invalid_attributes}, valid_session
        expect(assigns(:car_point)).to eq(car_point)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested car_point" do
      car_point = CarPoint.create! valid_attributes
      expect {
        delete :destroy, {:id => car_point.to_param}, valid_session
      }.to change(CarPoint, :count).by(-1)
    end
